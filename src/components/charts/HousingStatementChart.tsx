...
interface HousingStatementChartProps {
...
export function HousingStatementChart({
  positiveItems,
  compareYears,
  year,
  viewMode,
          ...
          <div className="health-subgroup-bar-panel">
            ...
            >
              ...
              >
                ...
                <div
                  className="statement-bar-plot health-subgroup-bar-plot"
  ...
  if (embedded) {
    return (
      <article className="health-assessment-lane-card health-assessment-lane-card--assessment housing-assessment-lane-card--statements">
        {content}
      </article>
    );
  }
  ...
  return (
    <div className="chart-card chart-card-fill health-subgroup-chart-card housing-statement-chart-card">
      {content}
    </div>
  );
}
